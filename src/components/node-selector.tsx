...
export function NodeSelector(
    ...
    const handleNodeSelect = useCallback((selection: NodeTypeOption) => {
        ...
        // check if there any other manual trigger (only 1 manual trigger)
        ...
        setNodes((nodes) => {
                ...
                // Converting screen coordinates to react-flow coordinates
                                ...
                                <div className="flex items-center gap-6 w-full overflow-hidden">
                                    {typeof Icon === "string" ? (
                                        <img
                                            src={Icon}
                                            alt={nodeType.label}
                                            className="size-5 object-center rounded-sm"
                                        />
                                    ) : (
